...
get_fresh_dump(dump_url,'../../tests/touchdown/rus-nw.osm.pbf')
...
cmd = '''osmconvert {dump_path} {bbox_string} --complete-ways --complex-ways -o={output_path_1}.o5m'''
...
cmd = 'python3 ../core/process_routes.py --dump_path ../../tests/touchdown/rus-nw-trolleybus.osm.pbf --filter "--tf accept-relations route=trolleybus" --output "../../tests/touchdown/" '
os.system(cmd)
